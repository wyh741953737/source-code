angular.module('wui.date',[]).directive('wuiDate', function() {
	...
	function fieldTemplate(scope, element, attr) {
		return(
			...
			'<span class="title">' +
			'<span class="txt" ng-click="openYearPicker()"><span>{{date.year}}</span> - </span>' + // cjflag 年 => -
			'<span class="txt" ng-click="openMonthPicker()"><span>{{date.month}}</span> </span>' + // cjflag 月 => - ''
			'</span>' +
			'<i class="iconfont" ng-click="nextMonth()">&#xe886;</i>' +
			'<i style="transform: matrix(-1, 0, 0, 1, -3, 0)" class="iconfont" ng-click="nextYear()">&#xe809;</i>' +
			'</div>' +
			...
			'<span class="txt" ng-click="openYearPicker()"><span>{{date.year}}</span> </span>' + // cjflag 年=》''
			'</span>' +
			'<i class="iconfont transformIcon" ng-click="nextYearByMonth()">&#xe809;</i>' +
			'</div>	' +
			'<div class="wui-date-picker_content">' +
			'<table class="wui-data-table">' +
			'<tr>' +
			'<td>' +
			'<a class="cell" ng-click="selectMonth(1)">Jan</a>' + // cjflag
			'</td>' +
			'<td>' +
			...
			'<span class="title">' +
			'<span class="txt"><span>{{date.yearList.startYear}}</span>  - <span>{{date.yearList.endYear}}</span> </span>' + // cjflag 年=》''
			'</span>' +
			'<i class="iconfont transformIcon" ng-click="pickNextYear()">&#xe809;</i>' +
			'</div>' +
			'<div class="wui-date-picker_content">' +
			'<table class="wui-data-table">' +
			'<tr>' +
