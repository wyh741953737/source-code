(function () {
	var app = angular.module('drop-processedzi-app',['service']);
	// var mark1 = 0;
	app.controller('drop-processedzi-ctrl',['$scope','$http','dsp','$routeParams',function ($scope,$http,dsp,$routeParams) {
		...
		//var orderType = $routeParams.type;
		if($routeParams.type){
