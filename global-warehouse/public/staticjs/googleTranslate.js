...
if (!window.doGTranslate) {
  let transNode = document.getElementById('google_translate_element2');
  if (!transNode) {
    transNode = document.createElement('div');
    transNode.id = 'google_translate_element2';
    transNode.style.display = 'none';
    document.body.appendChild(transNode);
  }
  ...
  // if (doGTranslate) {
  //   const language = storage.get('language') || 'en|en';
  //   if (language == 'en|en') {
  //     return;
  //   }
