...
let IconjiantouxiaoYou: FunctionComponent<Props> = ({
  size,
  color,
  ...rest
}) => {
...
IconjiantouxiaoYou.defaultProps = {
  size: 18,
};

IconjiantouxiaoYou = React.memo
  ? React.memo(IconjiantouxiaoYou)
  : IconjiantouxiaoYou;

export default IconjiantouxiaoYou;
