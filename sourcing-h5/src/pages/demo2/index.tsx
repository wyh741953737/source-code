...
import {
  CJView, CJImage, CJText, CJIcon,
} from '../../components/baseUI';
import { CJHeader, CJListView, CJEmptyData } from '../../components';
...
export default () => {
  ...
  let [dataSource, setDataSource] = useState<Item[] | null>(null);
...
// 请求数据列表
const requestDataList = (pageNum: number, pageSize: number): Promise<Item[]> => new Promise(resolve => {
  const dataList: Item[] = [];
  setTimeout(() => {
