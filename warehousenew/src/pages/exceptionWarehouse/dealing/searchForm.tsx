...
export default connect(({ exceptionWarehouseDealing, common }: any) => ({
  ...
  return (
    <Form form={form} className={style['search-form']}>
      <Row style={{ maxWidth: 1400 }}>
        ...
        {/*<Col span={8}>*/}
        {/*  <Form.Item name="status" label="状态" {...layout}>*/}
        {/*    <Select getPopupContainer={triggerNode => triggerNode.parentNode}  placeholder="全部" allowClear>*/}
        {/*      {EXCEPTIONPROCESSEDSTATUS.map(item => (*/}
        {/*        <Select.Option key={item.key} value={item.key}>*/}
        {/*          {item.value}*/}
        {/*        </Select.Option>*/}
        {/*      ))}*/}
