...
export default connect(({ secondStore }: any) => ({
  searchData: secondStore.searchData,
  dataSource: secondStore.dataSource,
  current: secondStore.current,
  pageSize: secondStore.pageSize,
  total: secondStore.total,
  loading: secondStore.loading,
  ...
  const columns = defaultColumns([
    ...
    { title: '货主编号', dataIndex: 'customerId', key: 'customerId' },
